...
*   PyNLPl：Python的自然语言处理库。还包含用于解析常见NLP格式的工具。[官网](https://github.com/proycon/pynlpl)
...
*   [gensim](http://radimrehurek.com/gensim/)：主题建模工具。[官网](https://github.com/piskvorky/gensim)
*   [PyBrain](http://www.pybrain.org/)：另一个机器学习库。[官网](https://github.com/pybrain/pybrain)
...
*   [Caffe](http://caffe.berkeleyvision.org/)：考虑了代码清洁、可读性及速度的深度学习框架。[官网](http://caffe.berkeleyvision.org/)
...
*   [TensorFlow](http://wiki.jikexueyuan.com/project/tensorflow-zh/)：用数据流图进行数值计算的开源软件库。[官网](https://github.com/tensorflow/tensorflow/)
...
*   [SciPy](https://www.scipy.org/)：基于Python的数学、科学、工程开源软件生态系统。[官网](http://www.scipy.org/)
*   [NumPy](http://www.numpy.org/)：Python科学计算基础包。[官网](http://www.numpy.org/)
...
*   [Pandas](http://pandas.pydata.org/)：这个库提供了高性能、易用的数据结构及数据分析工具。[官网](http://pandas.pydata.org/)
...
*   [matplotlib](http://matplotlib.org/)：Python的2D绘图库。[官网](http://matplotlib.org/)
...
*   PySpark：SparklingPandas Pandas（POPS）[官网](https://github.com/sparklingpandas/sparklingpandas)
